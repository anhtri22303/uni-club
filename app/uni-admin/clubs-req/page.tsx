...
export const clubRequests = [
  {
    ...
    category: "Technology",
    description: "A club dedicated to exploring artificial intelligence and machine learning technologies",
    ...
    reason: "To provide students with hands-on experience in AI/ML technologies and foster innovation in the field",
  },
  {
    id: "req-002",
    ...
    reason: "To create awareness about environmental issues and promote sustainable living practices among students",
  },
  {
    id: "req-003",
    ...
    expectedMembers: 15,
    faculty: "Fine Arts",
    reason: "To provide a platform for photography enthusiasts to learn and showcase their work",
  },
  {
    id: "req-004",
    ...
    expectedMembers: 30,
    faculty: "Business",
    reason: "To educate students about blockchain technology and its real-world applications",
  },
  {
    id: "req-005",
    ...
    expectedMembers: 50,
    faculty: "Psychology",
    reason: "To create a supportive community for mental health awareness and provide resources for students",
  },
]
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4">
            {filteredRequests.length === 0 ? (
              <Card>
                <CardContent className="py-8 text-center text-muted-foreground">No club requests found</CardContent>
              </Card>
            ) : (
              filteredRequests.map((request) => (
                <Card key={request.id} className="hover:shadow-md transition-shadow cursor-pointer">
                  <Link href={`/uni-admin/clubs-req/${request.id}`}>
