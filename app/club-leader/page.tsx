...
import { useClub, useProfile, useMemberApplications } from "@/hooks/use-query-hooks"
...
export default function ClubLeaderDashboardPage() {
  ...
  const { data: applications = [] } = useMemberApplications(clubId || 0, !!clubId)
        ...
        <div className="space-y-6">
          <div>
            <h1 className="text-3xl font-bold text-balance">
              Hello, {(profile as any)?.fullName || "Club Leader"} 👋
            </h1>
            {managedClub ? (
